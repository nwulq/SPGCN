...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='spgcn', type=str)
    parser.add_argument('--dataset', default='lap14', type=str, help='rest14, lap14, rest15, rest16, twitter')
    ...
    input_colses = {
        'spgcn': ['text_indices', 'aspect_indices', 'left_indices', 'dependency_graph', 'aspect_graph', \
                     'enhance_graph', 'fusion_graph'],
    }
    initializers = {
